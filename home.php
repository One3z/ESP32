...
<html>
  <head>
    <title>ESP32 DO AN</title> <!--<title>ESP32 WITH MYSQL DATABASE</title> -->
    ...
    <div class="content">
      <div class="cards">
        <div class="card header" style="border-radius: 15px;">
            <h3 style="font-size: 0.7rem;">Lich su du lieu ESP32 [ <span id="ESP32_01_LTRD"></span> ]</h3> <!-- <h3 style="font-size: 0.7rem;">LAST TIME RECEIVED DATA FROM ESP32 [ <span id="ESP32_01_LTRD"></span> ]</h3>-->
